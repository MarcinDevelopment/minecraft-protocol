...
object InventoryItemsPacket : Packet<InventoryItems> {
    ...
    override fun read(buffer: ByteBuf): InventoryItems {
        ...
        val slots = arrayListOf<ItemStack?>()

        for(i in 0 until buffer.readShort()) {
...
data class InventoryItems(val windowId: Int, val itemStacks: List<ItemStack?>) : PacketMessage
